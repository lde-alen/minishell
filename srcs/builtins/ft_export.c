...
/*   Updated: 2022/07/28 08:46:08 by asanthos         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 			val = ft_strlen(str) - ft_strlen(ft_strchr(str, '+'));
// 		else
// 			val = ft_strlen(str) - ft_strlen(ft_strchr(str, '='));
// 		env_name = ft_substr(str, 0, val);
// 	}
// 	while (lst->next != tmp)
// 	{
...
// 			if (check != NULL)
// 			{
// 				check_plus = ft_strchr(cmd_lst->argument[i], '+');
// 				div = ft_strchr(cmd_lst->argument[i], '=');
// 				check->value = ft_strchr(div, div[1]);
// 				if (check_plus != NULL && check_plus[1] == '=')
